...
import { GetUserProfile } from '@/service/GetProfile';
      ...
      <div>
        {user ?
          <div className='flex items-center gap-5'>
            <a href='/create-trip'>
              <Button varient="outline" className='rounded-full'>Create Trips</Button>
            </a>
            <a href='/my-trips'>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogDescription>
                ...
                Sign in to the app with Googele authentication securely
